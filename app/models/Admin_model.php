...
class Admin_model{
	...
	public function tambahDataAdmin($data){
		$query = "INSERT INTO ". $this->table.
				 " VALUES ('',:nama_admin,:username,:password,:tanggal_lahir, :telepon, :alamat)";
		$this->db->query($query);
	...
	public function ubahDataAdmin($data){
		$query = "UPDATE ". $this->table.
				" SET nama_admin=:nama_admin,username=:username,password=:password,tanggal_lahir=:tanggal_lahir, telepon=:telepon, alamat=:alamat".
				" WHERE id_admin=:id_admin";
		$this->db->query($query);
		$this->db->bind('nama_admin',$data['nama_admin']);
		$this->db->bind('username',$data['username']);
