    <div class="container mt-3">
        ...
        <div class="row mb-3">
            <div class="col-lg-12">
                <button type="button" class="btn btn-primary btn-block tambahData" data-toggle="modal" data-target="#formModal">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id" id="id">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" min="0" required>
                        </div>
                        <div class="form-group">
